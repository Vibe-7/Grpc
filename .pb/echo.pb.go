...
const file_echo_proto_rawDesc = "" +
	...
	"\x0eSayHelloStream\x12\x12.echo.HelloRequest\x1a\x13.echo.HelloResponse0\x01\x12A\n" +
	"\x14SayHelloClientStream\x12\x12.echo.HelloRequest\x1a\x13.echo.HelloResponse(\x01\x12D\n" +
	"\x15SayHelloBidirectional\x12\x12.echo.HelloRequest\x1a\x13.echo.HelloResponse(\x010\x01B\bZ\x06.pb;pbb\x06proto3"
...
var file_echo_proto_depIdxs = []int32{
	...
	0, // 1: echo.EchoService.SayHelloStream:input_type -> echo.HelloRequest
	0, // 2: echo.EchoService.SayHelloClientStream:input_type -> echo.HelloRequest
	0, // 3: echo.EchoService.SayHelloBidirectional:input_type -> echo.HelloRequest
	1, // 4: echo.EchoService.SayHello:output_type -> echo.HelloResponse
	1, // 5: echo.EchoService.SayHelloStream:output_type -> echo.HelloResponse
	1, // 6: echo.EchoService.SayHelloClientStream:output_type -> echo.HelloResponse
	1, // 7: echo.EchoService.SayHelloBidirectional:output_type -> echo.HelloResponse
